 ...
 * 
 * Professional landing page for the TAST3D platform
 */
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
            {content?.hero.headline || "Bring Your Menu to Life in 3D"}
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            {content?.hero.subheadline || "Interactive 3D visualizations help customers see what they're ordering"}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button 
              ...
              onClick={handleViewSampleMenu}
            >
              {content?.hero.primary_cta_text || "View Sample Menu"}
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
              ...
              onClick={handleContactUs}
            >
              {content?.hero.secondary_cta_text || "Contact Us"}
            </Button>
          </div>
            ...
            {content?.features.map((feature, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <div className={`w-16 h-16 mx-auto mb-4 ${getColorClass(feature.color)} rounded-full flex items-center justify-center`}>
